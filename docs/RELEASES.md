...
**Status: local implementation and acceptance; publication/cloud gate pending.** Metadata is synchronized at 1.21.0. The review-first campaign starter remains planned; this release repairs its historical-evidence prerequisite. No hosted deployment, live provider acceptance, signed installer distribution or whole-product completion is implied.
