...
## Current checkpoint: integrated 1.19 implementation
...
The current change set preserves the existing modular monolith plus workers architecture and introduces no new hosted service or schema beyond collector migration 0108.
