...
Keep web approval writes and ingestion workers stopped while restoring. Verify frozen migrations 0113–0114 plus base migration 0115 and additive hardening migration 0116/checksums against the deployed code, then validate every restored command by state before reopening. Release readiness must report exactly 116 migrations ending at `0116_source_preparation_recovery_hardening.sql`:
